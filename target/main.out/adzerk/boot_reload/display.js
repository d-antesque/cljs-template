...
return (function (p__1541){
var vec__1542 = p__1541;
var attr = cljs.core.nth.call(null,vec__1542,(0),null);
var v = cljs.core.nth.call(null,vec__1542,(1),null);
...
/** @this {Function} */
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq1548){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq1548));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__1552){
...
var data = map__1553__$1;
var message = cljs.core.get.call(null,map__1553__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__1553__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__1553__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__1555 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__1555,goog.events.EventType.CLICK,((function (G__1555,map__1553,map__1553__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__1555,map__1553,map__1553__$1,data,message,line,file))
);

return G__1555;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__1556){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__1560){
var map__1561 = p__1560;
var map__1561__$1 = ((((!((map__1561 == null)))?(((((map__1561.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1561.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1561):map__1561);
var messages = map__1561__$1;
var warnings = cljs.core.get.call(null,map__1561__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1561__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__1563 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__1563,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__1563,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__1564){
...
var messages = map__1565__$1;
var warnings = cljs.core.get.call(null,map__1565__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1565__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__1565,map__1565__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__1565,map__1565__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = ((cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings))));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__1565,map__1565__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__1565,map__1565__$1,messages,warnings,exception))
;
...
}catch (e1567){if((e1567 instanceof Error)){
var __1568 = e1567;
} else {
throw e1567;
